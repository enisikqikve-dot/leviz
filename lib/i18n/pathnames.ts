/**
 * Sprachen und uebersetzte Pfade -- ohne jede Abhaengigkeit.
 *
 * Getrennt von routing.ts, weil die App sie auch braucht: fuer Deep Links
 * (welche Website-Adresse ist welcher Bildschirm) und fuer Push-Ziele. Was
 * hier steht, gilt fuer Website und App gleichermassen -- eine Adresse, die
 * die Website kennt, kennt die App auch.
 */
